...
function AuthPage() {
  ...
  async function handleGoogle() {
    ...
    // Note: On success, Supabase will redirect the page, so no need to navigate manually here.
  }
          ...
          >
            ...
            <div className="mt-7 space-y-4">
              ...
              <form onSubmit={handleSubmit} className="space-y-3">
                ...
                <Button type="submit" className="w-full h-11 rounded-full mt-1 transition-all duration-300 hover:scale-[1.02] active:scale-[0.98]" disabled={busy}>
